                    ...
                    <div className="relative pt-24 md:pt-36">
                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                ...
                                <h1 className="mx-auto mt-8 max-w-4xl text-balance text-black dark:text-white text-5xl max-md:font-semibold md:text-7xl lg:mt-16 xl:text-[5.25rem]">
                                    The AI-ready home for team Commnication
                                </h1>
                                <p className="mx-auto mt-8 max-w-2xl text-balance text-black dark:text-white text-lg">
